...
// function objCompare (obj1, obj2, deep) {
//   if (obj1 === obj2) {
//     return true;
//   }
...
//         if (!objCompare(obj1[key], obj2[key], deep)) {
//           return false;
//         }
//       } else {
//         if (obj1[key] !== obj2[key]) {
...
//   return true;
// }
// console.log(objCompare({key: 'Value'}, {key: 'Value'}, true));
// console.log(objCompare({key: 'Value'}, {key: 'Value 1'}, true));
// console.log(objCompare({key: 'Value', nested: {key: 'Value'}}, {key: 'Value 1', nested: {key: 'Value'}}, true));
// console.log(objCompare({key: 'Value', nested: {key: 'Value'}}, {key: 'Value', nested: {key: 'Value'}}, true));
// console.log(objCompare({key: 'Value', nested: {key: 'Value'}}, {key: 'Value', nested: {key: 'Value'}}));
